...
def myplot(ismain=False,files=["dummy_file_name"],bl="x axis",sl="y axis",topl="title",dl="none",xr="auto",yr="auto",ds="n",width="1",doxkcd=False):
	if len(sys.argv) > 1:
	...
	try:
		...
		print("save to ",stime," failed.  Directory exists: ",os.path.isdir(os.getenv("HOME")+"/plot"))
		pass

...
1. [Format for our talk](#format-for-our-talk)
...
- 
    ...
    - 
        The statement <span style="color:red">FORALL</span> as an alternative to the DO-statement
    ...
    - 
        <span style="color:red">Automatic deallocation of allocatable arrays at exit of scoping unit</span>

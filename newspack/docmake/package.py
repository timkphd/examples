...
class Fhostone(Package):
    ...
    url      = "http://127.0.0.1:8000/fhostone-1.0.tar.gz"

    # FIXME: Add a list of GitHub accounts to
    # notify when the package is updated.
    # maintainers = ['github_user1', 'github_user2']

#### [tkaiser2@vs-login-1 example]$ sha256sum fhostone-1.0.tar.gz
#### a2dd3e6404f813da0d0768ff32190ec16aae59a4b338deaede58b7582df208ae  fhostone-1.0.tar.gz
#### [tkaiser2@vs-login-1 example]$
...
## If you don't do cmake just comment out the nest two lines
        where2="-DCMAKE_INSTALL_PREFIX="+thedir
        cmake(".",where2)
#        f.write("\ncmake")
## You should be able to add options to make if needed

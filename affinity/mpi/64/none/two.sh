...
srun --nodelist=$n1 --nodes=1-1    -n 64 ./stf_ii < st.in

#Intel MPI gfortran
mpif90  -O3 stf_01.f90 -o ./stf_ig
srun --nodelist=$n1 --nodes=1-1    -n 64 ./stf_ig < st.in
...
srun --nodelist=$n1 --nodes=1-1   -n 64 ./stf_og < st.in

#OpenMPI Intel compiler
export OMPI_FC=ifort
mpifort -O3 stf_01.f90 -o ./stf_oi
srun --nodelist=$n1 --nodes=1-1   -n 64 ./stf_oi < st.in

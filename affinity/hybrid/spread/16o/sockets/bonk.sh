...
srun   --cpu-bind=sockets,verbose -n 16 ./stf_ii < st.in

#Intel MPI gfortran
mpif90  -O3 -fopenmp StomOmpf_02d.f90 -o ./stf_ig
srun   --cpu-bind=sockets,verbose -n 16 ./stf_ig < st.in
...
srun  --cpu-bind=sockets,verbose -n 16 ./stf_og < st.in

#OpenMPI Intel compiler
export OMPI_FC=ifort
mpifort -O3 -fopenmp StomOmpf_02d.f90 -o ./stf_oi
srun  --cpu-bind=sockets,verbose -n 16 ./stf_oi < st.in

...
!     
!
!   Get Input Data.  First Build Derived Type.
...
!     'R': process grid will use row major ordering.
      CALL BLACS_GRIDINIT(BLACS_CONTEXT,'R',NPROC_ROWS,NPROC_COLS)
!
!
...
!**********************************************************************
      SUBROUTINE BUILD_INPUT_DATA_TYPE(INPUT_DATA_TYPE, N, &
                                       ...
                                       COL_BLOCK_SIZE)
! 
!  Build a derived datatype for transmitting the five input 
!  values in a single broadcast 
! 
      INCLUDE 'mpif.h'
!
!  Local Constant
...
!
      RETURN 
! 
!   End of Subroutine BUILD_INPUT_DATA_TYPE
      END 
!
!
!**********************************************************************

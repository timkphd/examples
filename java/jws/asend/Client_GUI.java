...
public class Client_GUI extends Frame {
    ...
    Panel buttonpanel;
    String base_dir = (String) "/home/tuxedo/misc/test/";
...
// Create a list of server choices.
        ...
        list.add("LOGTIME"); list.add("SCHEDULE");
    ...
    public boolean action(Event e, Object o){
    	...
    	if(e.target instanceof Button) {
    		if(send == e.target){
				...
				if(checkbox_group.getSelectedCheckbox().getLabel()=="Synchronous"){
			...
			try {
			    ...
			    Process prcs =rt.exec(base_dir+readthis);
			    String aline;

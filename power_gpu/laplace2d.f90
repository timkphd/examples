...
program laplace
  ...
  integer :: start_sys, stop_sys,icr
...
!$omp parallel do shared( Anew, A) reduction( max:error )
!$acc kernels
    do j=1,m-2
      do i=1,n-2
...
!$acc end data
  ...
  write(*,'(a,f10.3,a)')  ' total: ', stop_time-start_time, ' seconds'
  call system_clock(stop_sys,icr) 
  write(*,'(a,f10.3,a)')  ' total: ', real(stop_sys-start_sys)/icr, ' seconds'
